# -*- coding: utf-8 -*-
"""
Created on Tue May  8 20:45:03 2018
...
def dispTrainSamples(trainloader, classes):
...
def test(testloader, classes, net):
    correct = 0
    total = 0
    with torch.no_grad():
...
def dispPredictSamples(testloader, classes, net):
